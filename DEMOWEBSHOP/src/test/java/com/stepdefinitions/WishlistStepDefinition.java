...
public class WishlistStepDefinition {
    ...
    public void user_clicks_on_the_searched_product() {
        ...
        wishlistAction.openSearchedProduct(
                SearchStepDefinition.searchedProduct);
    }
    ...
    public void message_should_be_displayed(String expectedMessage) {
        ...
        String actualMessage =
                wishlistAction.getSuccessMessage();
    ...
    public void searched_product_should_be_added_to_the_wishlist() {
        ...
        String actualProduct =
                wishlistAction.getWishlistProductName();
    ...
    public void wishlist_should_be_empty() {
        ...
        String actualMessage =
                wishlistAction.getEmptyWishlistMessage();

        Assert.assertTrue(
                actualMessage.contains("The wishlist is empty"));
    }
    ...
    public void product_should_be_added_to_shopping_cart() {
        ...
        String actualProduct =
                wishlistAction.getCartProductName();
