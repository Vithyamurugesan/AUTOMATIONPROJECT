...
public class SearchStepDefinition {
    ...
    private static final Logger log =
            LogManager.getLogger(SearchStepDefinition.class);
    ...
    static final String CSV_FILE_PATH =
            ConfigReader.get("search.csv.path");
    ...
    public void user_is_on_the_home_page() {
        ...
        searchActions =
                new SearchActions(HelperClass.getDriver());
    ...
    public void user_enters_product_keyword_in_the_search_box(
        ...
        for (Map<String, String> row : data) {
            ...
            Assert.assertTrue(
                    searchActions.verifyResultsNotEmpty());
    ...
    public void user_enters_type_keyword_in_the_search_box(
        ...
        List<Map<String, String>> data =
                CsvReader.getData(CSV_FILE_PATH);
        ...
        if (keywords.isEmpty()) {
            ...
            log.error(
                    "No keyword found for type : " + type);
        ...
        for (String keyword : keywords) {
            ...
            if (type.equalsIgnoreCase("valid")) {
                ...
                Assert.assertTrue(
                        searchActions.verifySearchRedirect());
                ...
                log.info(
                        "Valid search assertions passed for : "
                                + keyword);
            }
                ...
                Assert.assertTrue(
                        searchActions.verifyNoProductMessage());

                Assert.assertFalse(
                        searchActions.verifyResultsNotEmpty());

                log.info(
                        "Invalid search assertions passed for : "
                                + keyword);
            }
                ...
                log.info(
                        "Case-insensitive assertions passed for : "
                                + keyword);
            }
    ...
    public void verify_products() {
        ...
        log.info("Validating results for: {}",
                searchedProduct);
...
//        Assert.assertTrue(
//                searchActions.verifyResultsContainKeyword(
//                        searchedProduct));

        log.info(
                "Matching products validated successfully");
    }
    ...
    public void user_clicks_on_search_button_without_entering_keyword() {
        ...
        log.info(
                "Clicking search without keyword");
    ...
    public void alert_should_be_shown_to_the_user() {
        ...
        Assert.assertTrue(
                searchActions.handleAlertIfPresent());
